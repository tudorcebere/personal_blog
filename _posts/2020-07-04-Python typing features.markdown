...
[Mapping](https://docs.python.org/3/library/typing.html#typing.Mapping) generic is the right way of describing key-value data structures like: `dict`, `ChainMap`, `TypedValue` or any custom key-value data structure.
